    ...
    return Column(
      children: [
        ListTile(
          ...
          title: AppText2(
            text: "Fahad", // Use the other user's email
            fontSize: 14.sp,
            fontWeight: FontWeight.w500,
            isTextCenter: false,
            textColor: themeColor,
        ...
        Expanded(
          child: StreamBuilder<List<MessageModel>>(
            stream: chatProvider.getFMessages(chatProvider.selectedChatRoom!.id),
            builder: (context, snapshot) {
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (message.type == 'image' && message.url != null) {
                          // Image message
                          return MessageBubble(
                            message: 'Image message', // You can show a placeholder or the type of message
                          ...
                          // Voice message
                          return MessageBubble(
                            message: 'Voice message', // Placeholder for voice message text
                            isSender: message.sender == chatProvider.currentUserId,
                            time: relativeTime,
                            type: message.type,
                            url: message.url, // Pass the voice URL to the MessageBubble
                          );
                        } else {
                          // Text message
                          return MessageBubble(
                            ...
                            time: relativeTime,
                            type: message.type,
                            url: message.url, // Pass URL if any (for image or voice)
                          );
                        }
                      },
                    ),
